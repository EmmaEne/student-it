    ...
    if (resourcesPage) {
        resourcesPage.innerHTML = `
            ...
            <div class="resource-grid">
                ...
                <div class="resource-detailed-card">
                    <div class="resource-icon-wrapper" style="background: rgba(16, 185, 129, 0.1); color: var(--success);">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width: 24px; height: 24px;">
                            <rect x="2" y="3" width="20" height="14" rx="2" ry="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/>
                        </svg>
                    </div>
                    <div class="resource-title">CSS Flexbox Guide</div>
                    <span class="resource-meta">Video • 12 min</span>
                </div>
                <div class="resource-detailed-card">
                    <div class="resource-icon-wrapper" style="background: rgba(245, 158, 11, 0.1); color: var(--warning);">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width: 24px; height: 24px;">
                            <path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/>
                        </svg>
                    </div>
                    <div class="resource-title">MDN Web Docs</div>
                    <span class="resource-meta">External Link</span>
                </div>
            </div>
        ...
        container.innerHTML = `
            <div class="shareable-log-card status-story-optimized">
                <div class="story-branding">
                    <img src="core/assets/logo/logo.svg" alt="StudentIT" class="story-logo">
