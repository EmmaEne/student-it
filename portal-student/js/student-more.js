    ...
    if (morePage) {
        morePage.innerHTML = `
            <div class="more-page-container">
                ...
                <!-- Developer Section (Testing only) -->
                <section class="settings-section">
                    <h3 class="settings-section-title">Developer Options</h3>
                    <div class="settings-group">
                        <a href="coordinator.html" class="settings-row">
                            <div class="settings-row-icon" style="background: #eef2ff; color: #4f46e5;">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    <path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/>
                                </svg>
                            </div>
                            <div class="settings-row-content">
                                <span class="settings-row-title">Switch to Coordinator View</span>
                            </div>
                            <svg class="settings-row-chevron" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <polyline points="9,18 15,12 9,6"/>
                            </svg>
